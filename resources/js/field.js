Nova.booting((Vue, router, store) => {
    ...
    Vue.component(
        "flexible-component-selector",
        require("./components/ComponentSelector.vue").default
    );
    Vue.component(
    ...
    Vue.component(
        "icon-arrow-down",
        require("./components/icons/ArrowDown.vue").default
    );
    Vue.component(
        "icon-arrow-up",
        require("./components/icons/ArrowUp.vue").default
    );
    Vue.component(
        "icon-plus-square",
        require("./components/icons/PlusSquare.vue").default
    );
    Vue.component(
        "icon-minus-square",
        require("./components/icons/MinusSquare.vue").default
    );
});
