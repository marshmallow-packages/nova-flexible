...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('flexible-component-selector', __webpack_require__(28));
    Vue.component('flexible-search-menu', __webpack_require__(33));
    Vue.component('delete-flexible-content-group-modal', __webpack_require__(37));
    Vue.component('icon-arrow-down', __webpack_require__(40));
    Vue.component('icon-arrow-up', __webpack_require__(42));
    Vue.component('icon-plus-square', __webpack_require__(44));
    Vue.component('icon-minus-square', __webpack_require__(46));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getGroup: function getGroup(item) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_0__group__["a" /* default */](layout.name, layout.title, item.attributes, this.field, item.key, true, layout);
        }
    }
});
    ...
    methods: {
        ...
        addGroup: function addGroup(layout, attributes, key, collapsed) {
            ...
            var fields = attributes || JSON.parse(JSON.stringify(layout.fields)),
                group = new __WEBPACK_IMPORTED_MODULE_2__group__["a" /* default */](layout.name, layout.title, fields, this.field, key, collapsed, layout);
          ...
          _vm.collapsed
            ? _c(
                "button",
                {
                  ...
                  attrs: { type: "button", title: _vm.__("Expand") },
                  on: {
            ...
            ? _c("div", [
                _c(
                  "button",
                  {
                    staticClass:
                      "group-control btn border-r border-40 w-8 h-8 block",
                    attrs: { type: "button", title: _vm.__("Collapse") },
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                      ...
                      [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", title: _vm.__("Move up") },
                            on: {
                              click: function($event) {
                                $event.preventDefault()
        ...
        _vm.group.title
          ? _c("div", { class: _vm.titleStyle }, [
              _c(
                "div",
                {
                  staticClass: "leading-normal pl-2",
                  class: { "border-b border-40": !_vm.collapsed }
                },
                [
                  _c("div", { staticClass: "flex" }, [
                    _c("div", { staticClass: "w-3/4" }, [
                      _c("p", { staticClass: "text-80 mt-1" }, [
                        _c("span", { staticClass: "mr-4 font-semibold" }, [
                          _vm._v("#" + _vm._s(_vm.index + 1))
                        ]),
                        _vm._v(" "),
                        _vm.group.title_from_content
                          ? _c("span", [
                              _c(
                                "span",
                                { staticClass: "mr-4 font-semibold" },
                                [_vm._v(_vm._s(_vm.group.title_from_content))]
                              )
                            ])
                          : _vm._e(),
                        _vm._v(
                    ...
                    _vm._v(" "),
                    !_vm.readonly && _vm.collapsed
                      ? _c("div", { staticClass: "w-1/4 text-right" }, [
                          _c(
                            "button",
                            {
                              staticClass:
                                "group-control btn border-l border-40 w-8 h-8",
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "group-control btn border-l border-40 w-8 h-8 mr-1",
...
Component.options.__file = "resources/js/components/ComponentSelector.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1e54d1be", Component.options)
  } else {
    hotAPI.reload("data-v-1e54d1be", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("573f79c9", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1e54d1be\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ComponentSelector.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1e54d1be\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ComponentSelector.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        toggleLayoutsTags: function toggleLayoutsTags(event) {
            ...
            try {
                for (var _iterator = document.querySelectorAll('.component-layout-selector')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var el = _step.value;
                    el.closest('.component-layout-column').style.display = 'none';
                }
            } catch (err) {
                _didIteratorError = true;
                _iteratorError = err;
            ...
            if (clicked_tag) {
                ...
                try {
                    for (var _iterator2 = document.querySelectorAll('[data-tag="' + clicked_tag + '"]')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                try {
                    for (var _iterator3 = document.querySelectorAll('.component-layout-selector')[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        var _el2 = _step3.value;
                        _el2.closest('.component-layout-column').style.display = 'block';
                    }
                } catch (err) {
          ...
          ? _c("div", { staticClass: "relative" }, [
              _vm.isLayoutsDropdownOpen
                ? _c(
                    ...
                    [
                      _c("div", { attrs: { id: "layout-selector-overlay" } }, [
                        _c(
                          "div",
                          {
                            staticClass: "overflow-scroll shadow-lg",
                            attrs: { id: "layout-selector" }
                          },
                          [
                            _c("div", { staticClass: "flex mb-4 h-100-p" }, [
                              _c(
                                "div",
                                {
                                  staticClass:
                                    "menu-container w-1/5 bg-grad-sidebar h-100-p pt-8"
                                },
                                [
                                  _c(
                                    "h4",
                                    {
                                      staticClass:
                                        "ml-8 mb-4 text-xs text-white-50% uppercase tracking-wide"
                                    },
                                    [_vm._v("Tags")]
                                  ),
                                  _vm._v(" "),
                                  _c(
                                    ...
                                    [
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "leading-tight mb-4 ml-8 text-sm"
                                        },
                                        [
                                          _c(
                                            "a",
                                            {
                                              staticClass:
                                                "text-justify text-white no-underline dim cursor-pointer",
                                              on: {
                                                click: _vm.toggleLayoutsTags
                                              }
                                            },
                                            [
                                              _vm._v(
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "components-container w-4/5 bg-gray-500 h-100-p p-3"
                                },
                                [
                                              ...
                                              _c(
                                                ...
                                                [
                                                  _c(
                                                    ...
                                                    {
                                                      staticClass:
                                                        "fill-current absolute search-icon-center ml-3 text-80",
                                                      attrs: {
                                                        xmlns:
                                                  ...
                                                  _c("input", {
                                                    ...
                                                    staticClass:
                                                      "pl-search w-full form-global-search",
                                                    attrs: {
                                                      type: "search",
                                                      placeholder:
                                                        "Search for your component here"
                                                    },
                                                    domProps: {
                                                      value: _vm.message
                                                    },
                                                    on: {
                                                      input: [
                                                        ...
                                                        function($event) {
                                                          return _vm.handleComponentSearch(
                                                            _vm.message
                                                          )
                                                        }
                                                      ]
                                        ...
                                        [
                                          _c(
                                            "button",
                                            {
                                              ...
                                              on: {
                                                click:
                                                  _vm.toggleLayoutsDropdownOrAddDefault
                                              }
                                            },
                                            [
                                              _vm._v(
                                  ...
                                  _c(
                                    ...
                                    _vm._l(_vm.visibleLayouts, function(
                                      layout
                                    ) {
                                      return _c(
                                        "div",
                                        ...
                                        [
                                          _c(
                                            ...
                                            {
                                              staticClass:
                                                "component-layout-selector max-w-sm rounded overflow-hidden shadow-lg cursor-pointer m-3",
                                              on: {
                                                click: function($event) {
                                                  return _vm.addGroup(layout)
                                                }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1e54d1be", module.exports)
  }
}
